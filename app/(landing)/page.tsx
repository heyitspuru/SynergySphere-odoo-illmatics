  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <section className={`relative py-24 overflow-hidden md:py-32 ${!isLoading ? 'animate-fade-in' : 'opacity-0'}`}>
        ...
        <div className="absolute hidden w-64 h-64 rounded-full md:block bg-violet-200/30 dark:bg-violet-800/10 blur-3xl animate-float top-12 left-12 mix-blend-multiply dark:mix-blend-overlay"></div>
        <div className="absolute hidden w-64 h-64 rounded-full md:block bg-indigo-200/30 dark:bg-indigo-800/10 blur-3xl animate-float-delayed bottom-24 right-12 mix-blend-multiply dark:mix-blend-overlay"></div>
        ...
        <div className="container relative px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 animate-fade-in-up [animation-delay:1000ms]">
            <div className="p-6 transition-all border shadow-sm bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md rounded-xl border-zinc-200 dark:border-zinc-800 hover:shadow-md hover:scale-105">
      ...
      <section id="features" className={`py-24 bg-zinc-50 dark:bg-zinc-900/50 ${!isLoading ? 'animate-fade-in [animation-delay:200ms]' : 'opacity-0'}`}>
        <div className="container px-4 mx-auto">
          <div className="mb-16 text-center">
            ...
            <p className="max-w-3xl mx-auto text-xl text-zinc-600 dark:text-zinc-400">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-5 lg:gap-16">
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                <Link href="#" className="transition-colors text-zinc-400 hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="#" className="transition-colors hover:text-white">Team Builder</Link></li>
                <li><Link href="#" className="transition-colors hover:text-white">Idea Generator</Link></li>
                <li><Link href="#" className="transition-colors hover:text-white">Event Tracker</Link></li>
                <li><Link href="#" className="transition-colors hover:text-white">Resources</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="#" className="transition-colors hover:text-white">API Reference</Link></li>
                <li><Link href="#" className="transition-colors hover:text-white">Tutorials</Link></li>
        ...
        <div className="flex items-center mb-4">
          <div className="mr-4">
            <div className="overflow-hidden border-2 rounded-full border-violet-200 dark:border-violet-800">
              <img src={avatar} alt={name} className="object-cover w-12 h-12" />
            </div>
          </div>
          <div>
